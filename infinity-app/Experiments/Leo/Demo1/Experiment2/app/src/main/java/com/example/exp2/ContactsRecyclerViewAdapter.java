...
import com.example.exp2.placeholder.PlaceholderContent.PlaceholderItem;
import com.example.exp2.databinding.FragmentSingleContactBinding;
...
public class ContactsRecyclerViewAdapter extends RecyclerView.Adapter<ContactsRecyclerViewAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        TextView modalDetails = dialog.findViewById(R.id.textView_modal);
        modalDetails.setMovementMethod(new ScrollingMovementMethod());
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View view) {
                //Toast.makeText(view.getContext(), "You just clicked" + viewHolder.mItem.details, Toast.LENGTH_SHORT).show();
                modalDetails.setText(viewHolder.mItem.details);
                dialog.show();
            }
        });
